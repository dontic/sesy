...
type SecondParameter<T extends (...args: never) => unknown> = Parameters<T>[1];
 ...
 options?: SecondParameter<typeof customAxiosInstance<PaginatedAudienceMemberList>>,) => {
 ...
 options?: SecondParameter<typeof customAxiosInstance<AudienceMember>>,) => {
      ...
      {url: `/sesy/projects/${projectPk}/members/`, method: 'POST',
 ...
 options?: SecondParameter<typeof customAxiosInstance<AudienceMember>>,) => {
      return customAxiosInstance<AudienceMember>(
      {url: `/sesy/projects/${projectPk}/members/${id}/`, method: 'PUT',
      headers: {'Content-Type': 'application/json', },
      data: audienceMemberRequest
    },
      options);
 ...
 options?: SecondParameter<typeof customAxiosInstance<SesyProjectsMembersUploadCsvCreate202>>,) => {const formData = new FormData();
formData.append(`file`, audienceMemberCsvUploadRequest.file);

      return customAxiosInstance<SesyProjectsMembersUploadCsvCreate202>(
      {url: `/sesy/projects/${projectPk}/members/upload-csv/`, method: 'POST',
 ...
 options?: SecondParameter<typeof customAxiosInstance<SesyTasksRetrieve200>>,) => {
  ...
  export type SesyProjectsMembersListResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsMembersList>>>
export type SesyProjectsMembersCreateResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsMembersCreate>>>
export type SesyProjectsMembersRetrieveResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsMembersRetrieve>>>
export type SesyProjectsMembersUpdateResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsMembersUpdate>>>
export type SesyProjectsMembersDestroyResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsMembersDestroy>>>
export type SesyProjectsMembersUploadCsvCreateResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsMembersUploadCsvCreate>>>
export type SesyTasksRetrieveResult = NonNullable<Awaited<ReturnType<typeof sesyTasksRetrieve>>>
