...
export const sesyApiKeysDestroy = (
 ...
 options?: SecondParameter<typeof customAxiosInstance<void>>,) => {
  ...
  export type SesyApiKeysListResult = NonNullable<Awaited<ReturnType<typeof sesyApiKeysList>>>
export type SesyApiKeysCreateResult = NonNullable<Awaited<ReturnType<typeof sesyApiKeysCreate>>>
export type SesyApiKeysDestroyResult = NonNullable<Awaited<ReturnType<typeof sesyApiKeysDestroy>>>
