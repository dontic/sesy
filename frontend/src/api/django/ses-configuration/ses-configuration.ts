...
type SecondParameter<T extends (...args: never) => unknown> = Parameters<T>[1];
 ...
 options?: SecondParameter<typeof customAxiosInstance<SESConfiguration>>,) => {
      return customAxiosInstance<SESConfiguration>(
      {url: `/sesy/ses-configuration/`, method: 'PUT',
 ...
 options?: SecondParameter<typeof customAxiosInstance<void>>,) => {
  ...
  export type SesySesConfigurationRetrieveResult = NonNullable<Awaited<ReturnType<typeof sesySesConfigurationRetrieve>>>
export type SesySesConfigurationUpdateResult = NonNullable<Awaited<ReturnType<typeof sesySesConfigurationUpdate>>>
export type SesySesConfigurationDestroyResult = NonNullable<Awaited<ReturnType<typeof sesySesConfigurationDestroy>>>
