...
type SecondParameter<T extends (...args: never) => unknown> = Parameters<T>[1];
 ...
 options?: SecondParameter<typeof customAxiosInstance<VerifiedDomain>>,) => {
      return customAxiosInstance<VerifiedDomain>(
      {url: `/sesy/projects/${projectPk}/domain/`, method: 'POST',
 ...
 options?: SecondParameter<typeof customAxiosInstance<void>>,) => {
  ...
  export type SesyProjectsDomainRetrieveResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsDomainRetrieve>>>
export type SesyProjectsDomainCreateResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsDomainCreate>>>
export type SesyProjectsDomainDestroyResult = NonNullable<Awaited<ReturnType<typeof sesyProjectsDomainDestroy>>>
